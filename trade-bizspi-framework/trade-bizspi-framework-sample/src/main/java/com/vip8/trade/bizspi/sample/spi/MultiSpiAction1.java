 ...
 */
@BizSpiImpl
public class MultiSpiAction1 implements MultiSpiAction {
    ...
    public List<String> invoke(Context ctx) {
        ...
        list.add("multi action result 1");
        System.out.println("MultiSpiAction impl 1 executed");
        return list;
    }

    @Override
    public SpiConfig config(Context ctx) {
        return SpiConfig.create("MultiSpiAction2", 1);
    }
}
